...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.masjoel.mediaservice.create"
        const val ACTION_DESTROY = "com.masjoel.mediaservice.destroy"
        const val PLAY = 0
        const val STOP = 1
    }
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.qs_hud_25_40)
        try {
